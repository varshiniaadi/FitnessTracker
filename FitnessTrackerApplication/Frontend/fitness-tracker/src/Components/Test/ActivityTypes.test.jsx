...
describe('activityTypes', () => {
  test('should have the correct activity types', () => {
    ...
    // Check if all expected activity types are present
    for (const [key, value] of Object.entries(expectedActivityTypes)) {
      expect(activityTypes[key]).toBe(value);
    }

    // Check if no unexpected activity types are present
    for (const key of Object.keys(activityTypes)) {
      expect(expectedActivityTypes).toHaveProperty(key, activityTypes[key]);
    }
  });
});
